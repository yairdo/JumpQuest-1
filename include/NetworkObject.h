...
protected:
	...
	//sending section
	template <class T>
	void sendUdpMessege(Messege_type,T ,const sf::IpAddress& ip = sf::IpAddress::None, 
	...
	void connectTcpSocket(const sf::IpAddress& ip, unsigned short port) { m_tcpSocket.connect(ip, port); }
